...
class PickerView: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource , UICollectionViewDataSource{
    ...
    var threec = ["ムスカリ（青）","ムスカリ（紫）","ムスカリ（白）","シネラリア（紫）","スイートアリッサム","アルメリア","フクジュソウ","スノードロップ","スノーフレーク"]
    ...
    var threeg = ["ソメイヨシノ","シダレザクラ","ムスカリ（青）","ムスカリ（紫）","ムスカリ（白）","ネモフィラ","シネラリア（紫）","スイートアリッサム","アルメリア","フクジュソウ","スノードロップ","スノーフレーク"]
    ...
    var fourj = ["ソメイヨシノ","シダレザクラ","ムスカリ（青）","ムスカリ（紫）","ムスカリ（白）","ネモフィラ","ガザニア（黄）","ガザニア（白）","ガザニア（オレンジ）","ガザニア（ピンク）","ガザニア（赤）","シネラリア（紫）","スイートアリッサム","スミレ(菫)","ベルフラワー","アルメリア","ラベンダー","フクジュソウ","スノーフレーク"]
    ...
    var fourc = ["ソメイヨシノ","ヤエザクラ","シダレザクラ","ムスカリ（青）","ムスカリ（紫）","ムスカリ（白）","ネモフィラ","ガザニア（黄）","ガザニア（白）","ガザニア（オレンジ）","ガザニア（ピンク）","ガザニア（赤）","アブチロン（オレンジ）","アブチロン（ピンク）","アブチロン（赤）","シネラリア（紫）","スイートアリッサム","スミレ(菫)","ベルフラワー","アルメリア","ラベンダー","フクジュソウ","スノーフレーク"]
    ...
    var fourg = ["ソメイヨシノ","ヤエザクラ","シダレザクラ","アマリリス（赤）","アマリリス（ピンク）","アマリリス（白）","ムスカリ（青）","ムスカリ（紫）","ムスカリ（白）","ネモフィラ","ガザニア（黄）","ガザニア（白）","ガザニア（オレンジ）","ガザニア（ピンク）","ガザニア（赤）","アブチロン（オレンジ）","アブチロン（ピンク）","アブチロン（赤）","シネラリア（紫）","スイートアリッサム","ブルーベル","スミレ(菫)","ベルフラワー","アルメリア","ラベンダー","フクジュソウ"]
    ...
    var fivej = ["ソメイヨシノ","ヤエザクラ","アマリリス（赤）","アマリリス（ピンク）","アマリリス（白）","アマリリス（黄色）","ムスカリ（青）","ムスカリ（紫）","ムスカリ（白）","ブルースター","ネモフィラ","ガザニア（黄）","ガザニア（白）","ガザニア（オレンジ）","ガザニア（ピンク）","ガザニア（赤）","アブチロン（オレンジ）","アブチロン（ピンク）","アブチロン（赤）","アヤメ（紫）","アヤメ（白）","シネラリア（紫）","スイートアリッサム","チョコレートコスモス","ブルーベル","スミレ(菫)","ベルフラワー","エニシダ","アルメリア","ラベンダー"]
    ...
    var fivec = ["赤バラ","白バラ","ピンクローズ","青バラ","黄バラ","オレンジローズ","黒バラ","アマリリス（赤）","アマリリス（ピンク）","アマリリス（白）","アマリリス（黄色）","ブルースター","ネモフィラ","ガザニア（黄）","ガザニア（白）","ガザニア（オレンジ）","ガザニア（ピンク）","ガザニア（赤）","アブチロン（オレンジ）","アブチロン（ピンク）","アブチロン（赤）","アヤメ（紫）","アヤメ（白）","シネラリア（紫）","スイートアリッサム","チョコレートコスモス","スミレ(菫)","ベルフラワー","グリーンローズ","パープルローズ","エニシダ","アルメリア","ラベンダー"]
    ...
    var fiveg = ["赤バラ","白バラ","ピンクローズ","青バラ","黄バラ","オレンジローズ","黒バラ","アマリリス（赤）","アマリリス（ピンク）","アマリリス（白）","アマリリス（黄色）","ブルースター","ネモフィラ","ガザニア（黄）","ガザニア（白）","ガザニア（オレンジ）","ガザニア（ピンク）","ガザニア（赤）","アブチロン（オレンジ）","アブチロン（ピンク）","アブチロン（赤）","アヤメ（紫）","アヤメ（白）","シネラリア（紫）","スイートアリッサム","チョコレートコスモス","スミレ(菫)","百(ユリ)","ベルフラワー","グリーンローズ","パープルローズ","エニシダ","アルメリア","ラベンダー"]
    ...
    var eievenj = ["赤バラ","白バラ","ピンクローズ","青バラ","黄バラ","オレンジローズ","黒バラ","アブチロン（オレンジ）","アブチロン（ピンク）","アブチロン（赤）","シネラリア（紫）","スイートアリッサム","チョコレートコスモス","イチョウ","グリーンローズ","パープルローズ"]
    ...
    var eievenc = ["赤バラ","白バラ","ピンクローズ","青バラ","黄バラ","オレンジローズ","黒バラ","シネラリア（紫）","スイートアリッサム","チョコレートコスモス","イチョウ","グリーンローズ","パープルローズ"]
    ...
    var eieveng = ["赤バラ","白バラ","ピンクローズ","青バラ","黄バラ","オレンジローズ","黒バラ","シネラリア（紫）","スイートアリッサム","チョコレートコスモス","イチョウ","グリーンローズ","パープルローズ"]
